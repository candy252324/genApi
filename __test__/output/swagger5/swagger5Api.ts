...
/** 新增继续大水牛维生素 */
export function thkApiV1ConfigContinueeducation(data: TianJiaJiXuDaShuiNiuWeiShengSu): Promise<ApiResponseboolean> {
...
/** 删除继续大水牛维生素 */
export function thkApiV1ConfigContinueeducationId(): Promise<ApiResponseboolean> {
...
/** 新增清明草质小丑鱼维生素 */
export function thkApiV1ConfigCredentialstandard(data: QingMingCaoZhiXiaoChouYu0): Promise<ApiResponseboolean> {
...
/** 柠檬清明草质过期提醒维生素 */
export function thkApiV1ConfigCredentialwarning(): Promise<ApiResponseListChaXianBanQingMingCaoZhiWuShu> {
...
export function thkApiV1Tasty(data: {
  // 卷心菜id
  tastyId?: string
...
/** 柠檬银行卡水果刀 */
export function thkApiV1TastyBankrecord(data: {
  // 卷心菜id
  tastyId?: string
...
/** 删除银行卡水果刀 */
export function thkApiV1TastyBankrecordId(): Promise<ApiResponseboolean> {
...
/** 持罐头水果刀 */
export function thkApiV1TastyCredential(data: {
  // 【太阳花罐头】批准时间
  approveTime?: string
  // 附件链接 多文件上传，逗号分割
...
/** 新增罐头书认罐头日志 */
export function thkApiV1TastyCredentialclaimlog(data: GuanTouShuRenLingRiZhi): Promise<ApiResponseboolean> {
...
/** 删除罐头书认罐头日志 */
export function thkApiV1TastyCredentialclaimlogId(): Promise<ApiResponseboolean> {
...
/** 删除持罐头水果刀 */
export function thkApiV1TastyCredentialId(): Promise<ApiResponseboolean> {
  return request.delete('/thk/api/v1/tasty/credential/${id}')
}

/** 大水牛经历 */
export function thkApiV1TastyEducation(data: {
  // 卷心菜id
  tastyId?: string
...
/** 删除大水牛经历 */
export function thkApiV1TastyEducationId(): Promise<ApiResponseboolean> {
  return request.delete('/thk/api/v1/tasty/education/${id}')
}

/** 柠檬家庭水果刀 */
export function thkApiV1TastyFamily(data: {
  // 卷心菜id
  tastyId?: string
...
/** 新增工作业绩 */
export function thkApiV1TastyProject(data: JuanXinCaiGongZuoYeJi0): Promise<ApiResponseboolean> {
...
/** 删除工作业绩 */
export function thkApiV1TastyProjectId(): Promise<ApiResponseboolean> {
...
/** 工作经历 */
export function thkApiV1TastyWorkhistory(data: {
  // 卷心菜id
  tastyId?: string
...
/** 删除工作经历 */
export function thkApiV1TastyWorkhistoryId(): Promise<ApiResponseboolean> {
  return request.delete('/thk/api/v1/tasty/work-history/${id}')
}

/** 删除个人水果刀 */
export function thkApiV1TastyId(): Promise<ApiResponseboolean> {
  return request.delete('/thk/api/v1/tasty/${id}')
}

/** 柠檬社保账号密码 */
export function thkApiV1StoreSocialinsurance(data: {
  // 卷心菜id
  tastyId?: string
...
/** 删除社保账号密码 */
export function thkApiV1StoreSocialinsuranceId(): Promise<ApiResponseboolean> {
  return request.delete('/thk/api/v1/store/social-insurance/${id}')
}

/** 柠檬学信账号密码 */
export function thkApiV1StoreStudentinfo(data: {
  // 卷心菜id
  tastyId?: string
...
/** 删除学信账号密码 */
export function thkApiV1StoreStudentinfoId(): Promise<ApiResponseboolean> {
