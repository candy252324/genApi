...
return {
code: Mock.mock("@integer(200,200)"),
"data": [BuLuoChengYuanXinXiDuiXiangBirdMemberResp(),BuLuoChengYuanXinXiDuiXiangBirdMemberResp(),BuLuoChengYuanXinXiDuiXiangBirdMemberResp()],
msg: Mock.mock("@string(5,100)"),
success: Mock.mock("@boolean()"),
timestamp: Mock.mock("@datetime()"),
traceId: Mock.mock("@string(5,100)"),
...
return {
current: Mock.mock("@integer(1,1)"),
"records": [DoorMainInfoResp(),DoorMainInfoResp(),DoorMainInfoResp()],
size: Mock.mock("@integer(20,50)"),
total: Mock.mock("@integer(11,52)"),
...
return {
current: Mock.mock("@integer(1,1)"),
"records": [XiaoDaoXiaoXiQiuQianXiangYing(),XiaoDaoXiaoXiQiuQianXiangYing(),XiaoDaoXiaoXiQiuQianXiangYing()],
size: Mock.mock("@integer(20,50)"),
total: Mock.mock("@integer(11,52)"),
...
return {
current: Mock.mock("@integer(1,1)"),
"records": [BuLuoDuiXiangBirdResp(),BuLuoDuiXiangBirdResp(),BuLuoDuiXiangBirdResp()],
size: Mock.mock("@integer(20,50)"),
total: Mock.mock("@integer(11,52)"),
...
return {
current: Mock.mock("@integer(1,1)"),
"records": [BuLuoChengYuanXinXiDuiXiangBirdMemberResp(),BuLuoChengYuanXinXiDuiXiangBirdMemberResp(),BuLuoChengYuanXinXiDuiXiangBirdMemberResp()],
size: Mock.mock("@integer(20,50)"),
total: Mock.mock("@integer(11,52)"),
...
return {
current: Mock.mock("@integer(1,1)"),
"records": [DaDuNanTongQianCaoQiuQianWhiteKeyBorardResp(),DaDuNanTongQianCaoQiuQianWhiteKeyBorardResp(),DaDuNanTongQianCaoQiuQianWhiteKeyBorardResp()],
size: Mock.mock("@integer(20,50)"),
total: Mock.mock("@integer(11,52)"),
...
"cardMessageIdList": [Mock.mock("@string(5,100)"),Mock.mock("@string(5,100)"),Mock.mock("@string(5,100)")],
channel: Mock.mock("@string(5,100)"),
clientMessageId: Mock.mock("@string(5,100)"),
content: Mock.mock("@string(5,100)"),
contentType: Mock.mock("@string(5,100)"),
"excludeKeyBorardIds": [Mock.mock("@string(5,100)"),Mock.mock("@string(5,100)"),Mock.mock("@string(5,100)")],
...
"receiverList": [Mock.mock("@string(5,100)"),Mock.mock("@string(5,100)"),Mock.mock("@string(5,100)")],
...
gratefulId: Mock.mock("@string(5,100)"),
gratefulName: Mock.mock("@string(5,100)"),
"keyBorardList": [DaDuNanTongQianCaoQiuQianWhiteKeyBorardResp(),DaDuNanTongQianCaoQiuQianWhiteKeyBorardResp(),DaDuNanTongQianCaoQiuQianWhiteKeyBorardResp()],
...
"msgList": [QingQiuHuiFuXiaoXiQiuQianReqMsgDetailResp(),QingQiuHuiFuXiaoXiQiuQianReqMsgDetailResp(),QingQiuHuiFuXiaoXiQiuQianReqMsgDetailResp()],
receiverAvatar: Mock.mock("https://www.uviewui.com/common/logo.png"),
receiverId: Mock.mock("@string(5,100)"),
receiverName: Mock.mock("@string(5,100)"),
