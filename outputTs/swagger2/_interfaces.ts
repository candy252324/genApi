...
export interface ResOfApiDingdingSyncDataFromDing {
  code: number
  data: object
  msg: string
  success: boolean
...
export interface ResOfApiDingdingTest {
  code: number
  data: object
  msg: string
  success: boolean
...
export interface ResOfApiCorpWechatWebLoginAuthUser {
  code: number
  data: ChannelUserResp
  msg: string
  success: boolean
...
export interface ResOfApiDingdingBindDingTenantAndUser {
  code: number
  data: CorpDingTenantUserResp
  msg: string
  success: boolean
  timestamp: number
}
export interface ResOfApiDingdingCreateAndBindDingTenantAndUser {
  code: number
  data: CorpDingTenantUserResp
  msg: string
  success: boolean
...
export interface ResOfApiCorpWechatWebLoginOauth2 {
  code: number
  data: CorpWechatAuthUrlResp
  msg: string
  success: boolean
...
export interface ResOfApiEnterpriseIdentificationInnerEnterpriseV1EnterpriseIdOpenAcctCallback {
  code: number
  msg: string
  success: boolean
  timestamp: number
}
export interface ResOfApiEnterpriseIdentificationInnerPersonV1UserIdOpenAcctCallback {
  code: number
  msg: string
  success: boolean
  timestamp: number
...
export interface ResOfApiChannelEmployeeCheckBindEmp {
  code: number
  data: boolean
  msg: string
  success: boolean
...
export interface ResOfApiChannelEmployeeCheckPhoneEx {
  code: number
  data: boolean
  msg: string
  success: boolean
...
export interface ResOfApiTenantChannelSyncCorp {
  code: number
  data: boolean
  msg: string
  success: boolean
...
export interface ResOfApiTenantChannelGetCorpTenant {
  code: number
  data: number
  msg: string
  success: boolean
...
export interface ResOfApiChannelEmployeeGetChannelAdminAndBind {
  code: number
  data: QuDaoQiYeGuanLiYuanYuBangDingQingKuang
  msg: string
  success: boolean
  timestamp: number
}
export interface ResOfApiTenantChannelAcquireChannelInfo {
  code: number
  data: QuDaoXinXiChuCan
  msg: string
  success: boolean
  timestamp: number
}
...
export interface CorpDingTenantUserResp {
  tenantId: number
}
...
export interface QuDaoQiYeGuanLiYuanYuBangDingQingKuang {
  /**管理员id*/
  adminId: string
  /**渠道企业corpId*/
  channelCorpId: string
...
export interface QuDaoXinXiChuCan {
  /**渠道企业id*/
  channelCorpId: string
  /**渠道类型*/
  channelType: string
...
export interface DingDingQuDaoZuHuBangDingRuCan {
  /**钉钉corpId*/
  corpId: string
  /**用户的钉钉Id*/
  dingId: string
...
export interface DingDingBangDing {
  /**区*/
  area: string
  /**市*/
  city: string
