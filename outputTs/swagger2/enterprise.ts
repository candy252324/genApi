...
import {
  ...
  ResOfApiEnterpriseIdentificationInnerEnterpriseV1EnterpriseIdOpenAcctCallback,
  ResOfApiEnterpriseIdentificationInnerPersonV1UserIdOpenAcctCallback,
...
/** 企业开户-（仅测试使用）认证结果通知 */
export function apiEnterpriseIdentificationInnerEnterpriseV1EnterpriseIdOpenAcctCallback(
  data: any,
  config?: AxiosRequestConfig
): AxiosPromise<ResOfApiEnterpriseIdentificationInnerEnterpriseV1EnterpriseIdOpenAcctCallback> {
  return Http.put(
...
/** 个人开户-(仅测试使用)认证结果通知 */
export function apiEnterpriseIdentificationInnerPersonV1UserIdOpenAcctCallback(
  data: any,
  config?: AxiosRequestConfig
): AxiosPromise<ResOfApiEnterpriseIdentificationInnerPersonV1UserIdOpenAcctCallback> {
  return Http.put(
